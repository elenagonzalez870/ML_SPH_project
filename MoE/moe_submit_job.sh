...
#SBATCH --array=0-7  # 5 agents (0, 1, 2)
...
conda activate ML  # Change to your venv path
...
# Run the wandb agent
# Type wandb sweep sweep_config.yaml to get the ID 

wandb agent elena-gonzalez-northwestern-university/ML_SPH_MoE/wljxyian