...
#SBATCH --array=0-4  # 5 agents (0, 1, 2, 3, 4)
...
# Type wandb sweep config_best_NN.yaml to get the ID 
# Run the wandb agent
wandb agent elena-gonzalez-northwestern-university/ML_SPH_NN_Classification/2r3v9fmt