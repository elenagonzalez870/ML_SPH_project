...
def save_results(grid_search, scaler, predictions_train, predictions_val, predictions_test, output_dir, results_dir):
    ...
    np.savez(f'{results_dir}/svr_results_poly.npz',  
    ...
    joblib.dump(save_obj_m1, f"{output_dir}/svr_best_model_poly_m1.pkl")
    ...
    joblib.dump(save_obj_m2, f"{output_dir}/svr_best_model_poly_m2.pkl")
    ...
    joblib.dump(save_obj_mejecta, f"{output_dir}/svr_best_model_poly_mejecta.pkl")
